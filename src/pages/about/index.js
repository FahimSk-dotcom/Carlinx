...
import teamposter1 from '../../../public/jpgs/teamposter1.jpg'
import teamposter2 from '../../../public/jpgs/teamposter2.jpg'
import teamposter3 from '../../../public/jpgs/teamposter3.jpg'
import teamposter4 from '../../../public/jpgs/teamposter4.jpg'
  ...
  return (
    <>
      ...
      <div className="team h-[80vh] flex flex-col items-center">
        ...
        <p className='text-5xl font-bold mt-2 mb-4'>Meet With Our <span className='text-accent'>Team</span></p>
        <div className="divider"></div>
        <div className="cards flex gap-10">
          {
            teamdata.map((data) => (
              <div key={data.id} className="Card h-[25rem] w-72 border-none rounded-xl">
                <Image src={data.img} height={300} width={260} className='border-none rounded-xl ml-4 mt-4'></Image>
